...
public class Antlr4.Runtime.VocabularyImpl : GLib.Object, Vocabulary
{
	 ...
	 *
	 * @param literal_names The literal names assigned to tokens, or {@code null}
	 * if no literal names are assigned.
	 * @param symbolic_names The symbolic names assigned to tokens, or
	 * {@code null} if no symbolic names are assigned.
	 * @param display_names The display names assigned to tokens, or {@code null}
	 * to use the values in {@code literal_names} and {@code symbolic_names} as
	 ...
	 * {@code token_names} array generated by previous releases of ANTLR.
	 *
	 ...
	 * value from {@code token_names} for the display names.</p>
	 *
	 * @param token_names The token names, or {@code null} if no token names are
	 * available.
	 * @return A {@link Vocabulary} instance which uses {@code token_names} for
