 ...
 */
[Version (since = "4.3")]
public class Antlr4.Runtime.Atn.ParseInfo : GLib.Object
{
	protected ProfilingATNSimulator atn_simulator { get; protected set; }

	public ParseInfo(ProfilingATNSimulator atn_simulator)
	{
		this.atn_simulator = atn_simulator;
	}
